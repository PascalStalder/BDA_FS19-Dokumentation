...
\newglossaryentry{Precision}{name={Precision},description={\[\dfrac{TP}{TP+FP}\]}}
\newglossaryentry{Accuracy}{name={Accuracy}, description={\[\dfrac{TP}{Anzahl\: moegliche\: Treffer}\]}}
